...
flowchart TD
  ...
  B --> C["Pulse preview 制品<br/>pulse-conversation-agent-gateway-v*.tgz"]
  B --> C2["客户服务制品<br/>conversation-agent-3.0.beta-sdk-*.tgz"]
  B --> D["Developer Assistant 仓库<br/>conversation-agent-dev-assistant"]

  C --> E["本地服务包目录<br/>pulse-conversation-agent-gateway-v*/"]
  C2 --> E2["客户本地服务包目录<br/>conversation-agent-3.0.beta-sdk/"]
